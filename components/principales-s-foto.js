...
export default function PrincipalesSFoto({principal}) {

    //const autor = principal.authors[0]?.name
    const volanta= principal.categories[0].name
  ...
  return (
    ...
    >
        <article>
            <p className="px-3 uppercase text-primary roboto font-bold pb-0">{principal.categories[0].name} </p>
